...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .brand-logo')) {
      document.querySelector('.navbar-brand .brand-logo').setAttribute('src', '../images/logo.png');
    }
    if (document.querySelector('.auth-main .brand-logo')) {
      document.querySelector('.auth-main .brand-logo').setAttribute('src', '../images/logo.png');
    }
