<div class="container mx-auto p-6 bg-gray-100 rounded-lg shadow-md">
    ...
    {{-- <form method="GET" action="{{ route('meetings.join') }}" class="space-y-4">
        ...
        <div>
            ...
            <input type="checkbox" name="is_moderator" id="is_moderator" value="1"
                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
        </div>
        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Join
            Meeting</button>
    </form> --}}
    ...
    <form method="GET" action="{{ route('meetings.recordings') }}" class="space-y-4">
        ...
        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Get
            Recordings</button>
    </form> --}}
