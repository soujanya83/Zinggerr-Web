...
<script>
    ...
    var countryNameToCode = {
        "Afghanistan": "af", "Albania": "al", "Algeria": "dz", "India": "in",
    ...
    function updateCountryData() {
        ...
        countryCodeInput.value = "+" + countryData.dialCode;
        countryNameInput.value = countryData.name;
        input.value = ""; // Clear phone input when country changes
    }

    document.querySelector("form").addEventListener("submit", function () {
        updateCountryData();
        if (input.value.trim() === "") input.value = ""; // Ensure null value in backend
    });
});
