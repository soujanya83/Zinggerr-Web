                    ...
                    <div class="card-header" style="margin-bottom: -28px;">
                        <div class="row align-items-center g-2">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="task_date" id="task_date"
                                                    required
                                                    value="{{ old('task_date', \Carbon\Carbon::parse($task->task_completion_date)->format('Y-m-d')) }}">
                                            </div>
                                        </div>
                                ...
                                <link href="https://cdn.jsdelivr.net/npm/summernote@0.9.0/dist/summernote-bs4.min.css"
                                    rel="stylesheet">
