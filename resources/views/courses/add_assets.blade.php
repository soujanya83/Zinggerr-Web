            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tab-content" id="myTabContent">
                        <h5>Create Chepters</h5>

                        <div class="row">
                            <div class="card-body" style="background-color: rgb(246, 233, 233)">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="chepter_name">Chepter Name:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="chepter_discription">Chepter Description:</label>
                                        ...
                                        <div class="upload-area text-end p-2">
                                            <button id="uploadButton_form" type="button" class="btn btn-success">Add
                                                Assets</button>
                                        </div>
                                        ...
                                        <!-- Dropdown Fields -->
                                        <div id="dropdownFields" style="display: none; margin-top: 10px;">
                                            ...
                                            {{-- <div class="row col-12">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="blog" class="form-select" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="blog_name" name="blog_name"
                                                            class="form-control" placeholder="Enter Chepter Name"
                                                            required value="{{ old('blog_name') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="mb-3">
                                                        ...
                                                        <div style="margin-top: 10px;">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="blogstatus" id="blogyes" value="1" checked>
                                                                <label class="form-check-label"
                                                                    for="blogyes">Yes</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="blogstatus" id="blogno" value="0">
                                                                <label class="form-check-label" for="blogno">No</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="mb-3">
                                                        <div class="upload-area text-end p-2">
                                                            <button id="uploadButton_form" type="button"
                                                                class="btn btn-danger">Add Blog
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr>
                                                <h5 class="p-2">Create Assets</h5>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="assets_discription">Assets Description:</label>
                                                        <textarea id="assets_discription" name="assets_discription"
                                                            class="form-control" placeholder="Enter Assets Description"
                                                            required>
                                                            {{ old('assets_discription') }}
                                                        </textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="mb-3">
                                                        <div class="upload-area text-end p-2">
                                                            <button id="uploadButton_form" type="button"
                                                                class="btn btn-primary">Add Topic
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="blog">Assets Metarials:</label>
                                                        <select name="assets_metarial" class="form-select" required>
                                                            <option value=""></option>
                                                            <option value="Assets Videos">Assets Videos</option>
                                                            <option value="Assets Images">Assets Images</option>
                                                            <option value="Video Link">Videos Link</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="blogAssetContainer"
                                                style="background-color: lightblue;padding:3px">
                                                {{-- <div class="blog-asset-block"> --}}
                                                    <!-- Blog + Asset Block -->
                                                    <div class="blog-asset-block">
                                                        <h5>Create Blog</h5>
                                                        <div class="row blog-item">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="mb-3">
                                                                    <label for="blogstatus">Blog Status:</label>
                                                                    <select name="blogstatus[]" class="form-select"
                                                                        required>
                                                                        <option value="1">Yes
                                                                        </option>
                                                                        <option value="0">No
                                                            ...
                                                            <div class="col-md-2 text-end">
                                                                <button type="button"
                                                                    class="btn btn-danger add-blog">Add Blog</button>
                                                                <button type="button"
                                                                    class="btn btn-secondary remove-blog d-none">Remove</button>
                                                            </div>
                                                        </div>

                                                        <div class="row topic-item"
                                                            style="background-color: #fbf4d8;padding:5px">
                                                            <hr>
                                                            <h5>Create Assets</h5>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="assets_discription">Assets
                                                                        Description:</label>
                                                                    <textarea id="assets_discription"
                                                                        name="assets_discription[]" class="form-control"
                                                                        placeholder="Enter Assets Description" required>
                                                                        {{ old('assets_discription') }}
                                                                    </textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 text-end">
                                                                <button type="button"
                                                                    class="btn btn-primary add-topic">Add Topic</button>
                                                                <button type="button"
                                                                    class="btn btn-secondary remove-topic d-none">Remove</button>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="mb-3">
                                                                        <label for="assets_metarial">Assets Materials:</label>
                                                                        <select name="assets_metarial[]" class="form-select" required>
                                                                            <option value=""></option>
                                                                            <option value="Assets Videos">Assets Videos</option>
                                                                            <option value="Assets Images">Assets Images</option>
                                            ...
                                            {{-- ....................model.................... --}}
                                            <!-- Modal for Assets Videos -->
                                            <div class="modal" tabindex="-1" id="assetsVideoModal">
                                                            ...
                                                            <form id="createCourseForm" method="POST"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label for="blog_name">Blog Name:</label>
                                                                            <input type="text" id="blog_name"
                                                                                name="blog_name" class="form-control"
                                                                                placeholder="Enter Blog Name" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label for="course_assets_video">Assets
                                                                                Video:</label>
                                                                            <input type="file" id="course_assets_video"
                                                                                name="course_assets_video"
                                                                    ...
                                                                    <div id="progressWrapper"
                                                                        ...
                                                                        <p id="progressText" class="mt-2 text-center">0%
                                                                        </p>
                                                                    </div>
