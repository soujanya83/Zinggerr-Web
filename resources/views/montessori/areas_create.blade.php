                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Create Areas</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header" style="margin-bottom: -28px;">
                        <div class="row align-items-center g-2">
                            <div class="col">
                                <h5>Create Montessori Areas</h5>
                            </div>

                            <div class="card-body">
                                <form id="permissionForm" action="{{ route('montessori.areas_store') }}" method="post"
                                    autocomplete="off">
                                    @csrf
