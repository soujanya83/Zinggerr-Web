...
@section('pageTitle', ' Montessori Update')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Update Areas</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header" style="margin-bottom: -28px;">
                        <div class="row align-items-center g-2">
                            <div class="col">
                                <h5>Update Montessori Areas</h5>
                            </div>

                            <div class="card-body">
                                <form id="permissionForm" action="{{ route('montessori.areas_update') }}" method="post"
                                    autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3 mt-4">
                                                <label for="status" style="color: #000"></label>
                                                <div>
                                                    <div class="form-check-inline">
                                                        <input class="form-check-input" type="radio" name="areas_status"
                                                            id="statusshow" value="1" {{ old('areas_status',
                                                            $getdata->status ?? 1) == 1 ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="statusshow"
                                                            style="color: #000">Publish</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="areas_status"
                                                            id="statushide" value="0" {{ old('areas_status',
                                                            $getdata->status ?? 1) == 0 ? 'checked' : '' }}>
