...
@section('pageTitle', ' Montessori Age Groups List')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Age Groups List</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center g-2">
                            ...
                            <div class="row align-items-center g-2">
                                <div class="col">
                                    <h5>Age Groups List</h5>
                                </div>
                                <div class="col-auto ms-auto d-flex">
                                    {{-- <input type="text" class="form-control me-2" id="searchPermissions"
                                        placeholder="Search Roles..."> --}}
                                    <button class="btn btn-sm btn-shadow btn-success"
                                        onclick="window.location.href='{{ route('montessori.age_groups_create') }}';"
                            ...
                            <table class="table table-striped table-bordered" id="permissionsTable">
                                <thead>
                                    <tr>
                                        ...
                                        (isset($permissions) && in_array('agegroup_delete', $permissions)))
                                        <th class="text-center">Action</th>
                                        @endif
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($all_agegroups as $index => $data)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('montessori.agegroup_edit',$data->slug) }}"
                                            ...
                                            (isset($permissions) && in_array('agegroup_delete', $permissions)))
                                            <a href="{{ route('montessori.agegroup_delete', $data->id) }}"
                                                class="avtar avtar-xs btn-link-secondary read-more-btn"
