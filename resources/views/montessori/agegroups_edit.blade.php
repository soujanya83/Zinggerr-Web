                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Update Age Groups</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header" style="margin-bottom: -28px;">
                        <div class="row align-items-center g-2">
                            <div class="col">
                                <h5>Update Montessori Age Group</h5>
                            </div>

                            <div class="card-body">
                                <form id="permissionForm" action="{{ route('montessori.agegroup_update') }}"
                                                ...
                                                <div>
                                                    <div class="form-check-inline">
                                                        <input class="form-check-input" type="radio" name="age_status"
                                                            id="statusshow" value="1" {{ old('age_status',
                                                            $getdata->age_status ?? 1) == 1 ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="statusshow"
                                                            style="color: #000">Publish</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="age_status"
                                                            id="statushide" value="0" {{ old('age_status',
                                                            $getdata->age_status ?? 1) == 0 ? 'checked' : '' }}>
